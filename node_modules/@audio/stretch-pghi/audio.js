// audio manifest — phase-gradient heap integration (Průša) — phaseless magnitude-only reconstruction.
...
import stretchFn from './pghi.js'

export const stretchPghi = (ctx) => {
...
stretchPghi.channels = 'any'
stretchPghi.streaming = false
stretchPghi.frames = (n, { params }) => Math.round(n * params.factor[0])
stretchPghi.params = {

// audio manifest — classic phase vocoder — per-bin phase propagation.
...
import stretchFn from './pvoc.js'

export const stretchPvoc = (ctx) => {
...
stretchPvoc.channels = 'any'
stretchPvoc.streaming = false
stretchPvoc.frames = (n, { params }) => Math.round(n * params.factor[0])
stretchPvoc.params = {

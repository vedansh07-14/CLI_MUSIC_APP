// audio manifest — pitch-synchronous overlap-add — epoch-aligned, monophonic material.
...
import stretchFn from './psola.js'

export const stretchPsola = (ctx) => {
...
stretchPsola.channels = 'any'
stretchPsola.streaming = false
stretchPsola.frames = (n, { params }) => Math.round(n * params.factor[0])
stretchPsola.params = {

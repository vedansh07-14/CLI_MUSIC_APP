// atom manifest — D-weighting (IEC 537, aircraft noise) per @audio/compile CONTRACT. Fixed standard curve:
...
import fn from './d-weighting.js'

export const dWeighting = (ctx) => {
	const chP = []

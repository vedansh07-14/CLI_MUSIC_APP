// audio manifest — phase-locked vocoder (Laroche & Dolson) — identity phase locking around spectral peaks.
...
import stretchFn from './pvoc-lock.js'

export const stretchPvocLock = (ctx) => {
...
stretchPvocLock.channels = 'any'
stretchPvocLock.streaming = false
stretchPvocLock.frames = (n, { params }) => Math.round(n * params.factor[0])
stretchPvocLock.params = {

// atom manifest — C-weighting (IEC 61672) per @audio/compile CONTRACT. Fixed standard curve:
...
import fn from './c-weighting.js'

export const cWeighting = (ctx) => {
	const chP = []

// audio manifest — spectral modeling synthesis — sinusoids + residual stretched separately.
...
import stretchFn from './sms.js'

export const stretchSms = (ctx) => {
...
stretchSms.channels = 'any'
stretchSms.streaming = false
stretchSms.frames = (n, { params }) => Math.round(n * params.factor[0])
stretchSms.params = {
